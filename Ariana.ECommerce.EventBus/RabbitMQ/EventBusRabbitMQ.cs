...
namespace Ariana.ECommerce.EventBus.RabbitMQ
{
    ...
    {
        const string BROKER_NAME = "ariana_ecommerce_event_bus";
        ...
        public EventBusRabbitMQ(IRabbitMQPersistentConnection persistentConnection, ILogger<EventBusRabbitMQ> logger,
            IApplicationBuilder applicationBuilder, IEventBusSubscriptionsManager subsManager, string queueName = null, int retryCount = 5)
        {
        ...
        private async Task ProcessEvent(string eventName, string message)
        {
            ...
            {
                using (var scope = _applicationBuilder.ApplicationServices.GetService<IServiceScopeFactory>().CreateScope())
                {
